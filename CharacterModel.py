...
class CharacterModel:
    def __init__(self):
        ...
        train_data_size = int(0.4 * guten_words_count)
        ...
        # validation_data_id = _file_to_char_ids(validation_data, char_to_id_train)
        #
        ...
        # # # Start : Code for test
        # test_data_id = _file_to_char_ids(test_data, char_to_id_train)
        #
        # print(test_data_id)
        #
        ...
        sess = tf.Session()
        tf.train.start_queue_runners(sess=sess)
        export_dir = os.path.join(relative_path_parent_dir, 'Server-saved-model/char_model_data')
        ...
        #     if predicted_char == ' ' and len(characters_generated) > 80:
        #         break
        #
